...
public class LabTwoMain {
    public static void main(String[] args) throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (info.length > 1) {
                if (info[3].equals("87.245.198.147") || info[4].equals("87.245.198.147")) {
...
class Paint extends javax.swing.JFrame {
    ...
    public Paint(int[] times, int[] trafficArr) {
        this.x = times;
        this.y = trafficArr;
    ...
    private void arrForGraphic() {
        for (int i = 0; i < x.length; i++) {
            ...
            y[i] /= 20;
            changedY[i] = startPointXoY.height - (y[i]);
        }
    }
}
